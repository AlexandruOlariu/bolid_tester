...
export const PID_REGISTRY: Record<string, PidDescriptor> = {
  ...
  '0122': def('0122', 'Fuel rail pressure (vac ref)', 'kPa', 2, (d) => (d[0] * 256 + d[1]) * 0.079),
  '0123': def('0123', 'Fuel rail gauge pressure', 'kPa', 2, (d) => (d[0] * 256 + d[1]) * 10),
  ...
  '0144': def('0144', 'Commanded equivalence ratio (λ)', '', 2, (d) => ((d[0] * 256 + d[1]) * 2) / 65536),
